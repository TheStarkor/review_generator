				...
				<FormLabel id="row-radio-buttons-group-label"  style={{marginTop:"10px"}}>
					...
					>
						...
						<HelpInfoTooltip 
							...
							title={
								<React.Fragment>
								  <Typography color="inherit">Opinions related to product shipping</Typography>
								  <p>{"Thoughts and opinions about delivery time"}</p>
								  <li style={{fontStyle: "italic"}}>{"Quotes : Got the earphones 3 days early."}</li>  
								  <p>{"Package condition"}</p> 
								  <li style={{fontStyle: "italic"}}>{"Quotes : The product came very worse packaged."}</li>  
								</React.Fragment>
							}
						>
							<HelpOutlineIcon style={{paddingLeft:'5px'}}/>
				...
				<Grid
					...
					>
						...
						<HelpInfoTooltip 
							...
							title={
								<React.Fragment>
								  <Typography color="inherit">Opinions related to product usage</Typography>
								  <p>{"Product quality evaluation (sound quality, bass, charging, connection, ….)"}</p>
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : The sound quality is awesome but the built quality of the product is at very low level."}</li>  
								  <p>{"Context of use"}</p> 
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : I used it when exercising."}</li>  
								  <p>{"Ease of use"}</p>
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : The earphones kept coming out of my ears."}</li>  
								  <p>{"Frequency of use"}</p> 
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : I use the product 2-3 times a week."}</li>  
								</React.Fragment>
							}
						>
							<HelpOutlineIcon style={{paddingLeft:'5px'}}/>
				...
				<Grid
					...
					>
						...
						<HelpInfoTooltip 
							...
							title={
								<React.Fragment>
								  <Typography color="inherit">Opinions about product issues and the company’s response</Typography>
								  <p>{"Warranty service"}</p>
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : The product is giving a two-year warranty."}</li>  
								  <p>{"Return"}</p> 
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : Product is returned."}</li>  
								  <p>{"Refund / Replace"}</p>
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : Hope to get it replaced at service centre."}</li>  
								  <p>{"Company’s communication about the product issue"}</p> 
								  <li style={{fontStyle: "italic"}}>{"Example Quotes : I've tried calling them but the always receive a 'network busy' error."}</li>  
								</React.Fragment>
							}
						>
							<HelpOutlineIcon style={{paddingLeft:'5px'}}/>
